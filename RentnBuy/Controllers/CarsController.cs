...
namespace RentnBuy.Controllers
{
    ...
    public class CarsController:Controller
    {
        ...
        public CarsController(IUnitOfWork unitOfWork, IWebHostEnvironment hostingEnvironment)
        {
        ...
        {
            return Json(new { data = _unitOfWork.Car.GetAll(null, null, "Category,CarType") });
        }
